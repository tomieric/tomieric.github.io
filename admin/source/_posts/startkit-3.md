...
通过`webpack`等工具编译后，`ES6`大部分语法转换成`ES5`, 大多数浏览器都支持`ES5`特性，个别浏览器需引入`es5-shime`等polyfill库。
...
模板传送门：[https://github.com/tomieric/react-webpack-boilerplate](https://github.com/tomieric/react-webpack-boilerplate)
